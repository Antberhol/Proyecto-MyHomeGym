        ...
        <div className="relative flex h-[640px] w-[360px] flex-col justify-between overflow-hidden rounded-[2rem] bg-gym-bgDark p-8 text-white">
            ...
            <main className="relative space-y-4">
                <div className="rounded-2xl border border-white/15 bg-white/5 p-4">
                    <p className="text-xs uppercase tracking-wide text-slate-300">{t('workoutShare.totalVolume')}</p>
            ...
            <footer className="relative text-sm text-slate-300">{t('workoutShare.footer')}</footer>
        </div>
    )
}
