const exerciseDbAliases: Record<string, string[]> = {
    ...
    'press militar': ['military press', 'barbell shoulder press', 'overhead press', 'standing barbell press'],
    ...
    'curl de biceps con barra': ['barbell curl', 'standing barbell curl', 'barbell bicep curl'],
    ...
    'curl martillo': ['hammer curl', 'dumbbell hammer curl', 'alternating hammer curl'],
    'curl en polea baja': ['cable curl', 'low cable curl', 'standing cable curl'],
    ...
    'rueda abdominal': ['ab wheel rollout', 'ab wheel', 'rollout'],
