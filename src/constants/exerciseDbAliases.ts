const exerciseDbAliases: Record<string, string[]> = {
    ...
    'curl bayesiano en polea': ['bayesian curl'],
    'curl concentrado': ['concentration curl'],
    'press frances': ['lying triceps extension', 'skull crusher'],
    'press frances con mancuerna a una mano': ['one arm dumbbell triceps extension'],
    ...
    'extension de triceps en polea con cuerda': ['rope tricep pushdown'],
